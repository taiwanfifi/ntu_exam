...
#### 2.6.1 連通分量（Connected Components）
...
#### 3.6.1 括號定理（Parenthesis Theorem）
...
#### 3.6.2 白色路徑定理（White-Path Theorem）
...
### 4.2 方法一：DFS 方法（Finish Time 遞減排序）
...
### 4.3 方法二：Kahn's Algorithm（BFS 方法）
...
### 4.5 何時拓撲排序唯一？→ DAG Hamiltonian Path
